...
def execute_command(command_id, command):
  try:
      ...
      return {"id": command_id, "status": command_status[command_id], "output": command_output[command_id], "quick": execution_time < 0.2}
  except Exception as e:
      command_status[command_id] = "failed"
      command_output[command_id] = f"Exception: {str(e)}"
      return {"id": command_id, "status": "error", "output": command_output[command_id], "quick": True}
